...
public class DetailActivity extends AppCompatActivity {
    ...
    TextView tvjudul, tvdate, tvrating, tvpopularity, tvlang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fav = findViewById(R.id.imgFavorite);
    ...
    private void showTrailer() {
        trailerAdapter = new TrailerAdapter(DetailActivity.this, modelTrailer);
